...
public class Ejercicio4Repaso {
    ...
    public static void main(String[] args) {
        ...
        Director director = new Director(5, "valentin", 41896019, 24);
        
        Corista corista = new Corista(2, "nicolas", 40392432, 26);
        
        CoroSemicircular coro = new CoroSemicircular("Hola", director, corista, 2);
        
        coro.agregarCorista(corista);
        
        Corista corista2 = new Corista(1, "Matias", 40392432, 26);
        
        coro.agregarCorista(corista2);
        
        
        System.out.println(coro.DeterminarSiEstaLLeno());
        
        System.out.println(coro.DeterminarSiEstanOrdenados());
